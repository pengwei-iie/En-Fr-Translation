...
def train():
    ...
    x_train, y_train = process_file(train_cnx, train_eny, word_to_id_cn, word_to_id_en, config.seq_length)
    x_val, y_val = process_file(val_cnx, val_eny, word_to_id_cn, word_to_id_en, config.seq_length)
